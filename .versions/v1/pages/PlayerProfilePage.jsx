  ...
  return (
    <div className="flex flex-col gap-8">
      <div
        ...
        style={{
          background: `linear-gradient(135deg, ${tier.color}22, #0c1410 45%, #070c09)`,
        }}
      >
        <div className="flex flex-wrap items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-display text-[11px] font-bold tracking-[0.18em] text-[#c9a227]">FICHA DE JUGADOR</p>
              <h1 className="font-display text-2xl font-extrabold uppercase text-[#f0e6c8]">@{username}</h1>
              {ratings.length > 0 ? (
        ...
        <div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {badges.map((b) => {
              const Icon = b.icon
              return (
                <div key={b.id} className="flex items-center gap-3 border border-[#243028] bg-[#0c1410] p-3">
