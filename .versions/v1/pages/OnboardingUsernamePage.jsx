...
export default function OnboardingUsernamePage() {
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 rounded-3xl border border-violet-500/20 bg-gradient-to-b from-violet-950/30 via-zinc-900/70 to-zinc-950 p-8 shadow-2xl backdrop-blur-md">
      <div>
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-violet-400">Gamer Passport</p>
        <h1 className="text-xl font-semibold text-zinc-50">Elegí tu usuario</h1>
        <p className="mt-1 text-sm text-zinc-400">Así te van a ver otros jugadores en torneos y en el ranking.</p>
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button
          type="submit"
          disabled={pending}
          className="rounded-xl bg-gradient-to-r from-violet-600 to-indigo-500 py-2.5 text-sm font-semibold text-white hover:from-violet-500 disabled:opacity-60"
        >
