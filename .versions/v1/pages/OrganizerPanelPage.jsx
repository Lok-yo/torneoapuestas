...
export default function OrganizerPanelPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <p className="font-display text-[11px] font-bold tracking-[0.18em] text-[#c9a227]">PISO</p>
        <h1 className="font-display text-2xl font-extrabold uppercase text-[#f0e6c8]">Panel de organizador</h1>
      </div>
