...
export default function MarketCard({ market }) {
  ...
  return (
    <Link
      ...
      className="flex flex-col gap-3 rounded-2xl border border-zinc-800 bg-zinc-900/60 p-4 backdrop-blur-md transition hover:border-violet-500/30"
    >
      <div className="flex items-center justify-between">
        <GameTag game={game} />
        <span className="font-mono text-xs text-zinc-500">{formatTCRED(market.volumeTCRED)} vol.</span>
      </div>
