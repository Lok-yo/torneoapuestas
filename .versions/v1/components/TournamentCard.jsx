...
export default function TournamentCard({ tournament }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-2xl border border-zinc-800 bg-zinc-900/60 p-4 backdrop-blur-md transition hover:border-violet-500/30 hover:bg-zinc-900"
    >
