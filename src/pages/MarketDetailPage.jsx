...
function SimulatedOrderBook({ outcomes }) {
  ...
  return (
    <div className="border border-[#242424] bg-[#0c0c0c] p-5 shadow-xl backdrop-blur-md">
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
        <div className="flex flex-col gap-6">
          ...
          <div className="border border-[#242424] bg-[#0c0c0c] p-6 shadow-xl backdrop-blur">
          ...
          {userPositions.length > 0 && (
            <div className="border border-[#242424] bg-[#0c0c0c] p-6 shadow-xl">
        ...
        <div className="flex flex-col gap-4">
          <div className="border border-[#242424] bg-[#0c0c0c] p-5">
            <h2 className="mb-1 flex items-center gap-2 font-display text-3xl font-bold text-white">
              <TrendingUp size={18} className="text-[#c6a46a]" /> Operar Mercado
            </h2>
            ...
            {market.status !== 'OPEN' ? (
              ...
              <form onSubmit={handleBuyShares} className="flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  disabled={pending}
                  className="btn-lime w-full py-3 disabled:opacity-50"
                >
